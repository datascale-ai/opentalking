...
def init_voice_store() -> None:
    ...
    try:
        ...
        seeds: list[tuple[int, str, str, str, str | None]] = [
            ...
            (202, "cosyvoice", "longhua", "longhua（示例）", None),
            (203, "cosyvoice", "longxiaochun_v2", "longxiaochun_v2（v2 示例）", None),
            # MiniMax
            (301, "minimax", "male-qn-qingse", "青涩青年 male-qn-qingse", None),
            (302, "minimax", "female-shaonv", "少女 female-shaonv", None),
            (303, "minimax", "male-qn-jingying", "精英青年 male-qn-jingying", None),
        ]
