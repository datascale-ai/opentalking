...
=== "wav2lip"
    ...
    [模型 → Wav2Lip](../model-deployment/wav2lip/local.md)。
...
=== "FlashTalk"
    ...
    入口见 [模型 → FlashTalk](../model-deployment/flashtalk.md)。
...
- [部署](../model-deployment/deployment.md) —— 多进程部署、Docker Compose 与生产建议。
