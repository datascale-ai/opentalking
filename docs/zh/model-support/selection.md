...
- 想同时验证本地语音识别、本地语音合成和 QuickTalk：看[模型部署 / 本地语音 + QuickTalk](../model-deployment/recipes/local-quicktalk-audio.md)。
...
| 本地语音验证 | SenseVoiceSmall + CosyVoice3 + QuickTalk | `local` | 验证本地 STT/TTS/Video |
