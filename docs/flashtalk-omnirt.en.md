# FlashTalk + OmniRT Deployment

> [中文](./flashtalk-omnirt.md) · English

This path is for high-quality digital-human output, private deployment, and enterprise GPU / NPU inference services. For a first OpenTalking run, start with [Quickstart](./quickstart.en.md) and the `demo-avatar / wav2lip` path.
