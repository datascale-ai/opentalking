...
The full guide has moved to [Model Deployment / Local Audio + QuickTalk](../model-deployment/local-quicktalk-audio.md).
...
To deploy local SenseVoiceSmall, local CosyVoice3, and the QuickTalk local path, read [Model Deployment / Local Audio + QuickTalk](../model-deployment/local-quicktalk-audio.md).
